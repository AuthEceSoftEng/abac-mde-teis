...
public class DeleteorderHandler{
    ...
    public DeleteorderHandler(String authHeader, int accountId, int orderId, UriInfo oApplicationUri){
    ...
    public JavaorderModel deleteJavaorderModel(){
		...
		if (pdp.getPermission(oAuthenticationAccount, "order", Integer.toString(oJavaorderModel.getorderId()), null, Action.DELETE)
