...
public class JavaorderControllerManager{
    ...
    public JavaorderModel postorder(@HeaderParam("authorization") String authHeader, @PathParam("accountId")int accountId, JavaorderModel oJavaorderModel){
        PostorderHandler oPostorderHandler = new PostorderHandler(authHeader, accountId, oJavaorderModel, oApplicationUri);
	...
	@GET
	@Produces("application/JSON")
    public JavaorderModelManager getorderList(@HeaderParam("authorization") String authHeader, @PathParam("accountId")int accountId){
        GetorderListHandler oGetorderListHandler = new GetorderListHandler(authHeader, accountId, oApplicationUri);
