...
public class PutorderproductHandler{
    ...
    public PutorderproductHandler(String authHeader, int orderId, int productId, JavaproductModel oJavaproductModel, UriInfo oApplicationUri, String strOptionalUpdateRelations, String strOptionalUpdateParent, String strOptionalRelationName, String strOptionalAddRelation, Integer iOptionalResourceId){
